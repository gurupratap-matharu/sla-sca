...
def extract_sla_patch(image):
    ...
    write_to_local(response=elevation, filename="exports/elevation.json")
    ...
    write_to_local(response=single_class_sos, filename="exports/single_class_sos.json")
    ...
    write_to_local(response=ice_area, filename="exports/ice_area.json")

    snow_area = calculate_area(elev_class_snow)
    write_to_local(response=snow_area, filename="exports/snow_area.json")

    ice_snow_area = ice_area.add(snow_area)
    write_to_local(response=ice_snow_area, filename="exports/ice_snow_area.json")
    ...
    write_to_local(response=ice_area_vec, filename="exports/ice_area_vec.json")

    ice_max = ee.Feature(ice_max_collection.first())
    write_to_local(response=ice_max, filename="exports/ice_max.json")
    ...
    write_to_local(response=ice_patch_area, filename="exports/ice_patch_area.json")
    ...
    write_to_local(response=ice_patch_ratio, filename="exports/ice_patch_ratio.json")
    ...
    write_to_local(response=snow_ice_image, filename="exports/snow_ice_image.json")
    ...
    write_to_local(response=touching_zone, filename="exports/touching_zone.json")
