...
var ING = ee.FeatureCollection("users/lcsruiz/Mapping_seasonal_glacier_melt_across_the_ANDES_with_SAR/Glaciares_Arg_Andes_dissolve");
...
var CloudMask = cloudScore.gt(cloudThresh).focal_min(contractPixels).focal_max(dilatePixels);
var CloudMasked  = img.updateMask(CloudMask.not());

////////////////////////////////////////////////////////////////////////////////
// projecting the cloud shadow
var CloudShadowMasked = projectShadows(CloudMask,img,cloudHeights,dilatePixels);
