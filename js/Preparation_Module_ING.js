...
exports.imageCollection = function(ing_id, startyear, endyear, cloudiness, coverage, filterDOYstart,filterDOYend,hsboolean,dem) {
...
var addquainfo = function(data) { //data is one image from the imagecollection (unfiltered)
                    ...
                    var image1 = image  .set('ING_ID', ing_id) //set ING to image
...
var saddquainfo = function(data) {
                    ...
                    var image1 = image.set('ING_ID', ing_id)
